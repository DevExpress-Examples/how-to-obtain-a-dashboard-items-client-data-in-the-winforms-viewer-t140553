...
Namespace Dashboard_ClientDataCards_Win
    Partial Public Class Form1
        ...
        Public Sub New()
            InitializeComponent()
            ' Enables the capability to access the dashboard item's client data.
            dashboardViewer1.UseDataAccessApi = True
        End Sub
        ...
        Private Sub dashboardViewer1_DashboardItemClick(ByVal sender As Object, _
            ...
            If e.DashboardItemName = "cardDashboardItem1" Then
                ...
                dataSource.Columns.Add("Actual", GetType(Decimal))
                dataSource.Columns.Add("Target", GetType(Decimal))

                ' Saves values of axis points placed on the "sparkline" axis and corresponding
                ' actual/target values to the data table.
                For Each point As AxisPoint In _
                    ...
                    If deltaValue.ActualValue.Value IsNot Nothing AndAlso _
        ...
        Private Function GetFormTitle(ByVal clickedItemData As MultiDimensionalData) As String
            Dim clickedPoint As AxisPoint = _
